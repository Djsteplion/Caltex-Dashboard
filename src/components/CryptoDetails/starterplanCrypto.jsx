...
import '../../components/CryptoDetails/starterplanCrypto.css';
    ...
    <div class="board">
        ...
        */}
                ...
                <div class="investment-buttons">
                        <Link to='/CryptoInvestForms/starterPlanInvC' class="invest-starterCrypto">Invest</Link>
                        <Link to='/Invest/InvestPage' class="change-starterCrypto">Change Plan</Link>
                </div>
                </div>

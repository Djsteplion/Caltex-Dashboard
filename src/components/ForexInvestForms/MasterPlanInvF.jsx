...
const MasterPlanInvF = () => {
    ...
    futureDate.setDate(currentDate.getDate() + 21); // add the number of days here
    ...
    const handleDateChange = (date) => {
        ...
        futureDate.setDate(date.getDate() + 21);
  ...
  return (
    ...
    <div class="board">
        ...
        */}
                ...
                {/*<!--Master Plan Invest Forex Form--> */}
               <div class="master-planInvestF" >
                <form action="#">
                    ...
                    <input type="number" id="amount" value={amount} onChange={handleAmountChange}  placeholder="$51,000 - $100,000"/>
                    </div><br/>
                    ...
                    <input type="text" id="doi" name="doi" placeholder="21 DAYS " readOnly/>
                    </div><br/>  

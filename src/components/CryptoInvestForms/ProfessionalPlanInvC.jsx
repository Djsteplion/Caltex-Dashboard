...
const ProfessionalPlanInvC = () => {
    ...
    futureDate.setDate(currentDate.getDate() + 20); // add the number of days here
    ...
    const handleDateChange = (date) => {
           // increase the futuredate by 20 days      
        const futureDate =new Date(date);
        futureDate.setDate(date.getDate() + 20);
    ...
    const handleAmountChange = (e) => {
        ...
        if (inputValue < 16000) {
            ...
            setROI('');   
             ...
             // calculate 3.0%(ROI) INTEREST
             const interest = inputValue * 0.035;
  ...
  return (
    ...
    <div class="board">
        ...
        */}
                ...
                {/* <!--Professional Plan Invest Crypto Form--> */}
                 <div class="professional-planInvestC"  >
                    <form action="#">
                        ...
                        <input type="number" id="amount" value={amount} onChange={handleAmountChange} placeholder="$16,000 - $100,000" />
                        </div><br/>
                        ...
                        <input type="text" id="doi" name="doi" placeholder="20 DAYS " readOnly/>
                        </div><br/>  
   ...
   value={futureYear} onChange = {(e) => setFutureYear(e.target.value)} id="dayOI"
    name="yearOI" placeholder='' readOnly/></span>
                        ...
                        <span class="invest-starter" onclick="congrat()">Invest</span>
                        </div>
...
export default ProfessionalPlanInvC
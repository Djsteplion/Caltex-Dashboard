...
const StarterPlanInvC = () => {
    ...
    futureDate.setDate(currentDate.getDate() + 10); // set the number of days here
    ...
    const handleDateChange = (date) => {
           // increase the futuredate by 10 days      
    ...
    const handleAmountChange = (e) => {
        ...
        if (inputValue < 300) {
            ...
            setROI('');   
             ...
             const interest = inputValue * 0.03;
  ...
  return (
    ...
    <div class="board">
        ...
        */}
                 ...
                 {/*<!--Starter Plan Invest Crypto Form-->*/}
                 <div class="starter-planInvestC"  >
                    <form action="#">
                        ...
                        <input type="number" id="amount" value={amount} onChange={handleAmountChange} placeholder="$300 - $15,000"/>
                        </div><br/>
                        ...
                        <input type="text" id="doi" name="doi" placeholder="10 DAYS" readOnly/>
                        </div><br/>  
...
export default StarterPlanInvC
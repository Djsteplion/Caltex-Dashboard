...
const MasterPlanInvC = () => {
    ...
    futureDate.setDate(currentDate.getDate() + 30); // add the number of days here
    ...
    const handleDateChange = (date) => {
           // increase the futuredate by 30 days      
    ...
    <div class="board">
        ...
        */}
                    <div class="welcome-user">
                       ...
                       {/* <!--Master Plan Invest Crypto Form--> */}
                       <div class="professional-planInvestC"  >
                    <form action="#">
                        <div class="invest-text">
                            <h3>Invest for Master Plan</h3>
                        </div>
                        
                        <div class="input-amount">
                        <span class="input-des">Input Amount</span>
                        <input type="number" id="amount" value={amount} onChange={handleAmountChange} placeholder="$101,000 - $UNLIMITED" />
                        </div><br/>
                        ...
                        <input type="text" id="doi" name="doi" placeholder="30 DAYS " readOnly/>
                        </div><br/>  

...
import '../../components/ForexDetails/starterplanForex.css';
    ...
    <div class="board">
        ...
        */}
                    ...
                    <div class="investment-buttons">
                        <Link to='/ForexInvestForms/starterPlanInvF' class="invest-starterForex">Invest</Link>
                        <Link to='/Invest/InvestPage' class="change-starterForex">Change Plan</Link>
                    </div>
                    </div>

...
import '../../components/ForexDetails/masterplanForex.css';
    ...
    <div class="board">
        ...
        */}
                ...
                <div class="investment-buttons">
                        <Link to='/ForexInvestForms/masterPlanInvF' class="invest-masterForex">Invest</Link>
                        <Link to='/Invest/InvestPage' class="change-masterForex">Change Plan</Link>
                    </div>
                </div>

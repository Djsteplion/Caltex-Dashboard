...
import '../../components/ForexDetails/professionalplanForex.css';
    ...
    <div class="board">
        ...
        */}
                        ...
                        <div class="invest-wt-caltex">
                            ...
                            <div class="forex-or-crypto">
                                <div class="forex-or-crypto-inner">
                                    <span class="forex" id="forex" >Forex</span>
                                    <Link to ='/Invest/InvestPage' class="crypto" id="crypto" >Crypto</Link>
                                </div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="investment-buttons">
                        <Link to='/ForexInvestForms/professionalPlanInvF' class="invest-professionalForex">Invest</Link>
                        <Link to='/Invest/InvestPage' class="change-professionalForex">Change Plan</Link>
                    </div>
                </div>
